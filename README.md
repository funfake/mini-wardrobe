...
```bash
npx react-native-reusables/cli@latest init -t mini-wardrobe
```
...
## Use Supbase
Import `import { supabase } from '/utils/supabase'` throughout your application to leverage the full power of Supabase!